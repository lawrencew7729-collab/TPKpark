...
const enPages = {
  ...
  news: {
    ...
    blocks: [
      { type: "newsFeature", kicker: "Latest update", category: "Leasing", date: "2026-09-03", title: "Leasing information is now available in three languages.", text: "Prospective tenants can review current information packs for shop and showroom units, a detached building and a semi-detached property in English, Bahasa Melayu or Chinese. Availability and commercial terms remain subject to confirmation.", image: images.leasing, alt: "Commercial and industrial properties available for lease at TPK Park in Puchong", route: "leasing", linkLabel: "Explore available properties" },
...
const zhPages = {
  ...
  news: {
    ...
    blocks: [
      { type: "newsFeature", kicker: "最新动态", category: "租赁", date: "2026-09-03", title: "租赁资料现已提供三种语言版本", text: "准租户现可用英文、马来文或中文查阅商铺与展厅、独立式建筑及半独立式单位的最新资料包。单位供应与商业条款仍须另行确认。", image: images.leasing, alt: "蒲种TPK Park待租商业与工业单位", route: "leasing", linkLabel: "查看出租单位" },
